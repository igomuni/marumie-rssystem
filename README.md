...
- **🔍 4つのビューモード**:
  ...
  - **支出ビュー**: 受給者からの逆引き - 特定支出先への全資金源を表示
...
- **特徴**: 受給者への全資金源を逆引き表示（支出元TopNデフォルト20）
- **ナビゲーション**: 任意のビューで受給者ノードをクリック
- **色**: **全ノード赤系**（支出の世界として統一表現）
- **今後の実装予定**: 支出元(TopN以外)ノードの追加
