...
|--------|--------------------------------------|--------------|---------|
| `/sankey` | `rs{YEAR}-structured.json.gz` | `normalize` → `generate-structured` → `compress-data` | 1-1, 1-2, 2-1, 5-1 |
...
| `/quality` | `project-quality-scores-{YEAR}.json`, `project-quality-recipients-{YEAR}.json.gz` | `normalize` → `score-quality` | 2-1, 5-1, 5-2 ＋ dictionaries/ |
