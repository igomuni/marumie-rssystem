...
KAKU_PATTERNS = [
    ...
    ('外国法人・国際機関', '外国企業',        r'リミテッド$|インコーポレーテッド$|コーポレーション$'),  # 外来語表記の法人格（全角）
    ...
    ('事業者',        '弁護士',              r'^個人[A-Za-z\d]弁護士'),          # 個人A弁護士等
    ('個人',          '個人',                r'^個人'),
    ('個人',          '在外研究員',          r'^在外研究員'),
    ('個人',          '在外出張者',          r'^在外出張者'),
    ...
    # ─ 匿名化個人 ────────────────────────────────────────────────────────────────
    ('事業者',        '弁護士',              r'^弁護士[\u4e00-\u9fff]+$'),      # 弁護士児島幸良等（弁護士+漢字人名）
    ('事業者',        '弁護士',              r'^弁護士[A-Za-z\d]$'),            # 弁護士A〜I（匿名化）
    ...
    ('事業者',        '弁護士',              r'国選弁護|契約弁護士|常勤弁護士'),  # 国選弁護人・契約弁護士・常勤弁護士（個人弁護士）
