...
KAKU_PATTERNS = [
    ...
    ('民間企業',      '民間企業（集合）',    r'その他民間|^その他事業者$|その他[（(]?[0-9]+社[）)]?|その他[0-9]+社|^民間企業$|^民間企業等|^民間企業[A-Za-z]|補助事業者\(民間企業\)|^企業[A-Za-z]{1,2}$|^地域企業[A-Za-z]$'),
    ...
    # ─ 匿名化法人・企業 フォールバック ─────────────────────────────────────────
    ('民間企業',      '民間企業（集合）',    r'^[A-Za-z]{1,3}社$'),        # A社, B社, ABC社
    ('民間企業',      '民間企業（集合）',    r'^(?:民間)?会社[A-Za-z\d]'),  # 会社A, 民間会社G/BE
    ('民間企業',      '民間企業（集合）',    r'^法人[A-Za-z\d]'),           # 法人A, 法人B
