 ...
 * formatBudget(123456789) // "約123兆円" (整数部3桁 → 小数なし)
 * formatBudget(12345678) // "約12.3兆円" (整数部2桁 → 小数第一位)
 * formatBudget(1234567) // "約1.2兆円" (整数部1桁 → 小数第一位)
 */
 ...
 * formatBudgetShort(12345678) // "12.3兆円" (整数部2桁 → 小数第一位)
 */
