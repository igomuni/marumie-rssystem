...
export function BudgetTypeBadge({ budgetType, count }: { budgetType: MOFBudgetType; count?: number }) {
  ...
  return <OutlineBadge label={count !== undefined ? `${label}×${count}件` : label} color={color} />;
}
